...
import "balancer-v2/interfaces/contracts/pool-utils/IBasePoolController.sol";
...
contract BasePoolController is IBasePoolController {
    ...
    event SwapFeeControllerChanged(
        address indexed oldSwapFeeController,
        address indexed newSwapFeeController
    );
