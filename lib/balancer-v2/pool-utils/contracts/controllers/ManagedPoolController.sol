...
import "balancer-v2/interfaces/contracts/pool-utils/IControlledManagedPool.sol";
...
contract ManagedPoolController is BasePoolController, IControlledManagedPool {
     ...
     */
    function setMustAllowlistLPs(bool mustAllowlistLPs)
        external
        virtual
        override
        onlyManager
     ...
     */
    function removeAllowedAddress(address member)
        external
        virtual
        override
        onlyManager
