...
import "balancer-v2/interfaces/contracts/standalone-utils/IProtocolFeePercentagesProvider.sol";

import "balancer-v2/solidity-utils/contracts/openzeppelin/SafeCast.sol";
...
abstract contract ProtocolFeeCache is RecoveryMode {
    ...
    constructor(
        ...
        // value is passed.
        bool delegatedProtocolSwapFees = protocolSwapFeePercentage ==
        ...
        if (delegatedProtocolSwapFees) {
            ...
            _require(
                protocolSwapFeePercentage <=
                    protocolFeeProvider.getFeeTypeMaximumPercentage(ProtocolFeeType.SWAP),
    ...
    function getProtocolFeePercentageCache(uint256 feeType) public view returns (uint256) {
        ...
        if (feeType == ProtocolFeeType.SWAP) {
            return
                getProtocolSwapFeeDelegation() ? _cache.swapFee : _fixedProtocolSwapFeePercentage;
