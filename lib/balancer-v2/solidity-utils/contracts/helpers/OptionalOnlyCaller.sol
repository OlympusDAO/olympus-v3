...
import "balancer-v2/interfaces/contracts/solidity-utils/helpers/IOptionalOnlyCaller.sol";
...
abstract contract OptionalOnlyCaller is IOptionalOnlyCaller, SignaturesValidator {
    ...
    function setOnlyCallerCheckWithSignature(
        ...
        bytes32 structHash = keccak256(
            abi.encode(_SET_ONLY_CALLER_CHECK_TYPEHASH, user, enabled, getNextNonce(user))
        );
