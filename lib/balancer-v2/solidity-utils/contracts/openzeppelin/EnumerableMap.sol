...
library EnumerableMap {
     ...
     */
    function at(IERC20ToBytes32Map storage map, uint256 index)
        internal
        view
        returns (IERC20, bytes32)
    {
     ...
     * within bounds.
     */
    function unchecked_at(IERC20ToBytes32Map storage map, uint256 index)
        internal
        view
        returns (IERC20, bytes32)
    {
     ...
     * read). O(1).
     */
    function unchecked_valueAt(IERC20ToBytes32Map storage map, uint256 index)
        internal
        view
        returns (bytes32)
    {
     ...
     * instead.
     */
    function unchecked_indexOf(IERC20ToBytes32Map storage map, IERC20 key)
        internal
        view
        returns (uint256)
    {
     ...
     * - `index` must be strictly less than {length}.
     */
    function at(IERC20ToUint256Map storage map, uint256 index)
        internal
        view
     ...
     * within bounds.
     */
    function unchecked_at(IERC20ToUint256Map storage map, uint256 index)
        internal
        view
        returns (IERC20, uint256)
    {
     ...
     * read). O(1).
     */
    function unchecked_valueAt(IERC20ToUint256Map storage map, uint256 index)
        internal
        view
        returns (uint256)
    {
     ...
     * instead.
     */
    function unchecked_indexOf(IERC20ToUint256Map storage map, IERC20 key)
        internal
        view
        returns (uint256)
    {
