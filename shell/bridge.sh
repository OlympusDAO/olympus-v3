...
# Bridges OHM to the specified address and chain
#
# Usage:
# ./bridge.sh --fromChain <chain> --toChain <chain> --to <recipient address> --amount <amount> --account <cast wallet> --broadcast <false> --env <file>
#
...
forge script ./src/scripts/ops/Bridge.s.sol:BridgeScript \
    --sig "bridge(string,string,address,uint256)()" $fromChain $toChain $to $amount \
