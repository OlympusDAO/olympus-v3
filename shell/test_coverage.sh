...
lcov --output-file lcov-pruned.info --ignore-errors unused --remove lcov.info 'src/test/**/*.sol' --remove lcov.info 'src/scripts/**/*.sol' --remove lcov.info 'src/external/**/*.sol' --remove lcov.info 'src/libraries/**/*.sol' --remove lcov.info 'lib/**/*.sol'
