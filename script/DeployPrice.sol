...
contract DeployPrice is Script {
  ...
  function run() external returns (GoerliDaoPrice price) {
    ...
    address gdaoEthPriceFeed = 0xdC8E4eD326cFb730a759312B6b1727C6Ef9ca233; // address -> oracle? MockPrice contract (deploy first)
    uint48 gdaoEthUpdateThreshold = 86400; //1x a day
    address reserveEthPriceFeed = 0xdC8E4eD326cFb730a759312B6b1727C6Ef9ca233; // address -> oracle? MockPrice contract (deploy first)
