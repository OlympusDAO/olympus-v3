...
contract GDAOStakingDeploy_2 is Script {
  ...
  function run() external returns (GoerliStaking staking) {
    ...
    // address gdao = vm.envAddress("GOERLI_GDAO"); // make sure updated in .env //tgd
    address gdao = vm.envAddress("GOERLI_TGD"); // make sure updated in .env //tgd
    ...
    uint256 epochLength = 2200;
    uint256 firstEpochNumber = 500;
