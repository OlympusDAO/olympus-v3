...
- [PolicyAdminOptimized](../../src/policies/utils/PolicyAdminOptimized.sol)
...
`PolicyAdminOptimized` was in the LayerZero bridge audit scope. It is re-listed here so that the
role semantics the CCIP policies inherit are covered as one unit. The hooks the two policies override
