...
# This script executes a proposal's actions on a testnet via Tenderly VNet.
#
# Usage: src/scripts/proposals/executeOnTenderly.sh --file <proposal-path> --contract <contract-name> --env <env-file>
#
...
TENDERLY_ACCOUNT_SLUG=$TENDERLY_ACCOUNT_SLUG TENDERLY_PROJECT_SLUG=$TENDERLY_PROJECT_SLUG TENDERLY_VNET_ID=$TENDERLY_VNET_ID TENDERLY_ACCESS_KEY=$TENDERLY_ACCESS_KEY forge script $file:$contract --sig "executeOnTenderly()" --rpc-url $RPC_URL
