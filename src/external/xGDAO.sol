...
contract xGDAO is IxGDAO, ERC20 {
    ...
    constructor(address _migrator, address _sGDAO)
        ERC20("Governance GDAO", "xGDAO", 18)
    {
     ...
     * @param _sGDAO address
     */
    function migrate(address _staking, address _sGDAO) external override onlyApproved {
        ...
        require(_sGDAO != address(0), "Zero address found");
        sGDAO = IsGDAO(_sGDAO);
    }
    ...
    /**
     * @notice pull index from sGDAO token
     */
    ...
    /**
        @notice converts xGDAO amount to OHM
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts OHM amount to xGDAO
        @param _amount uint
        @return uint
     */
