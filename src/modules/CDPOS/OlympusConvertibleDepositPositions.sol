        ...
        return
            string.concat(
                ...
                string.concat(
                    ...
                    cdSymbol,
                    "-OHM Convertible Deposit</tspan></text>"
                ),
                string.concat(
                    '<rect x="33" y="477" width="434" height="90" rx="9" fill="#2C2E37" /><text xml:space="preserve" class="standard-text"><tspan x="42" y="503.16">Conversion Price</tspan><tspan x="457" y="503.003" text-anchor="end">',
                ...
                string.concat(
                    '<text xml:space="preserve" class="standard-text"><tspan x="42" y="551.16">Position Expiration</tspan><tspan x="457" y="551.003" text-anchor="end">',
