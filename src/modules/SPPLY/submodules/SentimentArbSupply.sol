...
/// @title      SentimentSupply
/// @author     0xJem
/// @notice     SPPLY submodule representing OHM in Sentiment on Arbitrum
contract SentimentArbSupply is CustomSupply {
    // ========== CONSTRUCTOR ========== //
    ...
    function SUBKEYCODE() public pure override returns (SubKeycode) {
        return toSubKeycode("SPPLY.SENTIMENTARB");
    }
