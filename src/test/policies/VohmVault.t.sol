...
contract VohmVaultTest is Test {
    ...
    function setUp() public {
        ...
        // policies
        vOHMvault = new VohmVault(kernel, OHM);
    ...
    function testCorrectness_deposit() public {
        ...
        vm.startPrank(user1);
        OHM.approve(address(vOHMvault), amt);
        vOHMvault.deposit(amt);
        vm.stopPrank();

        assertEq(OHM.balanceOf(user1), 0);
    ...
    function testCorrectness_withdraw() public {
        ...
        assertEq(OHM.balanceOf(user1), amt);
