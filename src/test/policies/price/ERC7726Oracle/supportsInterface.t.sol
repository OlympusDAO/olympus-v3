...
contract ERC7726OracleSupportsInterfaceTest is ERC7726OracleTest {
    ...
    function test_supportsInterface() public view {
        ...
        IERC165 erc165Oracle = IERC165(address(oracle));
        assertTrue(
            erc165Oracle.supportsInterface(type(IERC7726Oracle).interfaceId),
            "IERC7726Oracle mismatch"
        );
        assertTrue(erc165Oracle.supportsInterface(type(IERC165).interfaceId), "IERC165 mismatch");
        assertTrue(
