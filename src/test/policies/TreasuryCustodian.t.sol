...
contract TreasuryCustodianTest is Test {
    ...
    function test_requestPermissions() public {
        Permissions[] memory expectedPerms = new Permissions[](12);
        ...
        expectedPerms[6] = Permissions(TRSRY_KEYCODE, TRSRY.addAsset.selector);
        expectedPerms[7] = Permissions(TRSRY_KEYCODE, TRSRY.addAssetLocation.selector);
        expectedPerms[8] = Permissions(TRSRY_KEYCODE, TRSRY.removeAssetLocation.selector);
        expectedPerms[9] = Permissions(TRSRY_KEYCODE, TRSRY.addCategoryGroup.selector);
        expectedPerms[10] = Permissions(TRSRY_KEYCODE, TRSRY.addCategory.selector);
        expectedPerms[11] = Permissions(TRSRY_KEYCODE, TRSRY.categorize.selector);
