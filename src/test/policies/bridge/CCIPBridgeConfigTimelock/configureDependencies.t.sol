...
contract CCIPBridgeConfigTimelockTests_configureDependencies is CCIPBridgeConfigTimelockTest {
    ...
    function test_givenRolesModuleNotInstalled_reverts() public {
        (, , CCIPBridgeConfigTimelock foreignTimelock) = _deployStackOnForeignKernel();
    ...
    //   [X] it reverts with CCIPBridgeConfigTimelock_InvalidModuleVersion
    ...
    function test_givenRolesModuleMajorVersionIsNot1_reverts() public {
        ...
        (, CCIPBridgeConfigTimelock freshTimelock) = _deployStackOnKernel(freshKernel);
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ICCIPBridgeConfigTimelock.CCIPBridgeConfigTimelock_InvalidModuleVersion.selector
            )
        );
        freshTimelock.configureDependencies();
