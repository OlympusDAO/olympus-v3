...
contract CCIPBridgeConfigTimelockTests_keyViews is CCIPBridgeConfigTimelockTest {
    ...
    // [X] RATE_LIMITS_DOMAIN equals keccak256("CCIP_BRIDGE_CONFIG_RATE_LIMITS")
    // [X] REMOTE_POOLS_DOMAIN equals keccak256("CCIP_BRIDGE_CONFIG_REMOTE_POOLS")
    // [X] ROUTE_IDENTITY_DOMAIN equals keccak256("CCIP_BRIDGE_CONFIG_ROUTE_IDENTITY")
    // [X] ALLOWLIST_DOMAIN equals keccak256("CCIP_BRIDGE_CONFIG_ALLOWLIST")
    ...
    function test_domainConstantsMatchDocumentedStrings() public view {
        ...
        assertEq(
            allowList,
            keccak256("CCIP_BRIDGE_CONFIG_ALLOWLIST"),
    ...
    function test_givenSecondConfigInstance() public {
        (
            CCIPBridgeConfig secondConfig,
            CCIPBridgeConfigTimelock secondTimelock
