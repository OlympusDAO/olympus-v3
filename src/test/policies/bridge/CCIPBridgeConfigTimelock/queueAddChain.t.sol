...
contract CCIPBridgeConfigTimelockTests_queueAddChain is CCIPBridgeConfigTimelockTest {
    ...
    function test_whenRemotePoolListIsEmpty_reverts() public givenEnabled {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ICCIPBridgeConfig.CCIPBridgeConfig_RemotePoolsEmpty.selector)
        );
        vm.prank(bridgeAdmin);
        timelock.queueAddChain(update);
    }
