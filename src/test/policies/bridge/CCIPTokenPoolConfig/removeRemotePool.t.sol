...
contract CCIPTokenPoolConfigTests_removeRemotePool is CCIPTokenPoolConfigTest {
        ...
        givenChainAdded
    {
        ...
        emit ICCIPTokenPoolConfig.RouteRemotePoolRemoved(CHAIN_SELECTOR_A, REMOTE_POOL_TWO);
        vm.prank(admin);
        config.removeRemotePool(CHAIN_SELECTOR_A, REMOTE_POOL_TWO);
