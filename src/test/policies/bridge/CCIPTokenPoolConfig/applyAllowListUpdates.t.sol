...
contract CCIPTokenPoolConfigTests_applyAllowListUpdates is CCIPTokenPoolConfigTest {
        ...
        givenPoolOwnershipAccepted
    {
        ...
        emit ICCIPTokenPoolConfig.AllowListUpdated(removes, adds);
        vm.prank(admin);
        ...
        givenPoolOwnershipAccepted
    {
        ...
        assertEq(
            _countLogs(logs, address(config), ICCIPTokenPoolConfig.AllowListUpdated.selector),
            1,
        ...
        givenPoolOwnershipAccepted
    {
        ...
        vm.recordLogs();
        vm.expectEmit(true, true, true, true, address(config));
        emit ICCIPTokenPoolConfig.AllowListUpdated(new address[](0), adds);
        vm.prank(admin);
        config.applyAllowListUpdates(new address[](0), adds);
