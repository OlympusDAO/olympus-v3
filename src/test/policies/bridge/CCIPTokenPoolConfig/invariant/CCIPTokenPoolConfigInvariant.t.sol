...
// Contracts
import {CCIPTokenPoolConfigHandler} from "./CCIPTokenPoolConfigHandler.sol";
import {CCIPTokenPoolConfigTest} from "../CCIPTokenPoolConfigTest.sol";

/// @notice Stateful invariant suite for CCIPTokenPoolConfig. The fuzzer drives the handler's
...
contract CCIPTokenPoolConfigTests_Invariants is CCIPTokenPoolConfigTest {
    CCIPTokenPoolConfigHandler internal handler;
    ...
    function setUp() public override {
        ...
        handler = new CCIPTokenPoolConfigHandler(
            config,
            ohm,
            ccipRouter,
            rmnProxy,
