...
contract CCIPTokenPoolConfigTests_supportsInterface is CCIPTokenPoolConfigTest {
    ...
    function _advertisedInterfaceIds() internal pure returns (bytes4[] memory interfaceIds) {
        ...
        interfaceIds[0] = type(ICCIPTokenPoolConfig).interfaceId;
    ...
    //   [X] it returns true for ICCIPTokenPoolConfig
    ...
    function test_whenInterfaceIsAdvertised() public view {
        assertTrue(
            config.supportsInterface(type(ICCIPTokenPoolConfig).interfaceId),
            "ICCIPTokenPoolConfig should be advertised"
        );
        assertTrue(
    ...
    // [X] type(ICCIPTokenPoolConfig).interfaceId differs from type(IConfigOperator).interfaceId
    ...
    function test_advertisedInterfaceIdsAreDistinct() public pure {
        ...
        assertTrue(
            type(ICCIPTokenPoolConfig).interfaceId != type(IConfigOperator).interfaceId,
