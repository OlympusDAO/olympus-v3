...
contract CCIPBridgeConfigTests_setRateLimitAdmin is CCIPBridgeConfigTest {
    ...
    function test_whenCallerIsAdmin() public givenEnabled givenPoolOwnershipAccepted {
        ...
        emit ICCIPBridgeConfig.PoolRateLimitAdminSet(rateLimitAdmin);
        vm.prank(admin);
        ...
        givenChainAdded
    {
        ...
        vm.expectEmit(true, true, true, true, address(config));
        emit ICCIPBridgeConfig.PoolRateLimitAdminSet(address(0));
        vm.prank(admin);
    ...
    function test_whenRateLimitAdminIsAnyAddress(
        ...
        vm.expectEmit(true, true, true, true, address(config));
        emit ICCIPBridgeConfig.PoolRateLimitAdminSet(rateLimitAdmin_);
        vm.prank(admin);
