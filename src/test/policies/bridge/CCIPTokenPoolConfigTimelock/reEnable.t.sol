...
contract CCIPTokenPoolConfigTimelockTests_reEnable is CCIPTokenPoolConfigTimelockTest {
    ...
    // given the config policy has been deactivated in the kernel
    //   [X] it reverts with CCIPTokenPoolConfigTimelock_ConfigNotActive carrying the config
    //       address
