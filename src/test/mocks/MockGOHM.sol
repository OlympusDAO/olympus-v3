...
contract MockGOHM is ERC20 {
    ...
    constructor(address migrator_, address sohm_)
    ...
    function setApproved(address approved_) public {
        approved = approved_;
    }

    function setMigrated(bool migrated_) public {
        migrated = migrated_;
    }

    function migrate(address staking_, address sohm_) external {
        migrated = true;
        approved = staking_;
        sOHM = IsOHM(sohm_);
    }
