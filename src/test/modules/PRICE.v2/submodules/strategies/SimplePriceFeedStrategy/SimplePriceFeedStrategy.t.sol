...
/// @title Tests for SimplePriceFeedStrategy
/// @notice Tests for price aggregation functions (excluding getAveragePriceExcludingDeviations)
contract SimplePriceFeedStrategyTest is SimplePriceFeedStrategyBase {
