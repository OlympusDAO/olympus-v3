...
contract OlympusPriceConfig is Policy, Auth {
    ...
    function changeMovingAverageDuration(uint48 movingAverageDuration_) external requiresAuth {
    ...
    function changeObservationFrequency(uint48 observationFrequency_) external requiresAuth {
