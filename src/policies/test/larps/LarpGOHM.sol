...
contract LarpGOHM is IgOHM, LarpERC20 {
    ...
    constructor(address _migrator, address _sOHM)
        LarpERC20("Governance OHM", "gOHM", 18)
    {
     ...
     * @param _sOHM address
     */
    function migrate(address _staking, address _sOHM)
        external
        override
        onlyApproved
    {
    ...
    /**
        ...
        @return uint
     */
    function balanceFrom(uint256 _amount)
        public
        view
        override
        returns (uint256)
        ...
        returns (uint256)
    {
        require(
            ...
            "gOHM::getPriorVotes: not yet determined"
        );
