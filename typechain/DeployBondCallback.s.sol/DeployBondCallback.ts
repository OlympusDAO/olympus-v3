...
export interface DeployBondCallbackInterface extends utils.Interface {
  functions: {
...
export interface DeployBondCallback extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployBondCallbackInterface;
