...
export interface DeployPriceConfigInterface extends utils.Interface {
  functions: {
...
export interface DeployPriceConfig extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployPriceConfigInterface;
