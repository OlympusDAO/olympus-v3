...
export interface DeployMockPriceFeedInterface extends utils.Interface {
  functions: {
...
export interface DeployMockPriceFeed extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployMockPriceFeedInterface;
