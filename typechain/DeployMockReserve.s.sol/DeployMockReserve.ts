...
export interface DeployMockReserveInterface extends utils.Interface {
  functions: {
...
export interface DeployMockReserve extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployMockReserveInterface;
