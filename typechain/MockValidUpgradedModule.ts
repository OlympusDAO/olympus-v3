...
export interface MockValidUpgradedModuleInterface extends utils.Interface {
  functions: {
...
export interface MockValidUpgradedModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockValidUpgradedModuleInterface;
