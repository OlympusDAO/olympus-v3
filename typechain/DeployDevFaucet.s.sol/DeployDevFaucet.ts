...
export interface DeployDevFaucetInterface extends utils.Interface {
  functions: {
...
export interface DeployDevFaucet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployDevFaucetInterface;
