...
export interface IBondAuctioneerInterface extends utils.Interface {
  functions: {
...
export interface IBondAuctioneer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBondAuctioneerInterface;
