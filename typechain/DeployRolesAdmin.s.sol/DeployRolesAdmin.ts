...
export interface DeployRolesAdminInterface extends utils.Interface {
  functions: {
...
export interface DeployRolesAdmin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployRolesAdminInterface;
