...
export interface DeployTreasuryCustodianInterface extends utils.Interface {
  functions: {
...
export interface DeployTreasuryCustodian extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployTreasuryCustodianInterface;
