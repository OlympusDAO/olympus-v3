...
export interface MockLegacyAuthorityInterface extends utils.Interface {
  functions: {
...
export interface MockLegacyAuthority extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockLegacyAuthorityInterface;
