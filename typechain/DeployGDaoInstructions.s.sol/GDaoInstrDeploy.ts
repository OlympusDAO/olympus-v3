...
export interface GDaoInstrDeployInterface extends utils.Interface {
  functions: {
...
export interface GDaoInstrDeploy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GDaoInstrDeployInterface;
