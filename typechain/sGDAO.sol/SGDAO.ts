...
export interface SGDAOInterface extends utils.Interface {
  functions: {
    ...
    "setxGDAO(address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "setxGDAO", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "stakingContract",
    data: BytesLike
  ): Result;
...
export type LogStakingContractUpdatedEvent = TypedEvent<
  [string],
  LogStakingContractUpdatedEventObject
>;
...
export interface SGDAO extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SGDAOInterface;
