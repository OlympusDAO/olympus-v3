...
export interface PriceConfigTestInterface extends utils.Interface {
  functions: {
    ...
    "testCorrectness_onlyAuthorizedCanCallAdminFunctions()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testCorrectness_onlyAuthorizedCanCallAdminFunctions"
      | "userCreator"
      | "vm"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testCorrectness_onlyAuthorizedCanCallAdminFunctions",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PriceConfigTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PriceConfigTestInterface;
