...
export interface DeployMockPriceInterface extends utils.Interface {
  functions: {
...
export interface DeployMockPrice extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployMockPriceInterface;
