...
export interface DeployParthenonInterface extends utils.Interface {
  functions: {
...
export interface DeployParthenon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployParthenonInterface;
