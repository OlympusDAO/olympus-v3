...
export interface GoerliDaoVotesInterface extends utils.Interface {
  functions: {
...
export interface GoerliDaoVotes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoerliDaoVotesInterface;
  ...
  functions: {
    ...
    transfer(
      ...
      amt_: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
