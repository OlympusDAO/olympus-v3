...
export interface DeployBondAggregatorInterface extends utils.Interface {
  functions: {
...
export interface DeployBondAggregator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployBondAggregatorInterface;
