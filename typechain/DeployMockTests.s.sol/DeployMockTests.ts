...
export interface DeployMockTestsInterface extends utils.Interface {
  functions: {
...
export interface DeployMockTests extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployMockTestsInterface;
