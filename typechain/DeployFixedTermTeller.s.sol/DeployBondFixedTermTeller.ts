...
export interface DeployBondFixedTermTellerInterface extends utils.Interface {
  functions: {
...
export interface DeployBondFixedTermTeller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployBondFixedTermTellerInterface;
