...
export interface DeployEmergencyInterface extends utils.Interface {
  functions: {
...
export interface DeployEmergency extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployEmergencyInterface;
