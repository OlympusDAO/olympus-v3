...
export interface MockInvalidModuleInterface extends utils.Interface {
  functions: {
...
export interface MockInvalidModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockInvalidModuleInterface;
