...
import type { BondBaseSDA, BondBaseSDAInterface } from "../BondBaseSDA";
...
export class BondBaseSDA__factory {
  static readonly abi = _abi;
  static createInterface(): BondBaseSDAInterface {
    return new utils.Interface(_abi) as BondBaseSDAInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BondBaseSDA {
    return new Contract(address, _abi, signerOrProvider) as BondBaseSDA;
  }
}
